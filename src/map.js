...
{selectedMarker && (
            ...
            >
              ...
              <div>          <select  value={typebac}  onChange={(e)=>{setTypebac(e.target.value)}} className="typebac">  
               ...
               </select>   <input  value={numParc}  onChange={(e)=>{setNumparc(e.target.value)}} className="parcimp" type="text" placeholder="Numero de parc" />
              </div> 
